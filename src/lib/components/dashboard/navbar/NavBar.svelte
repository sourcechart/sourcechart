...
<div class="flex justify-center justify-items-center">
	<NavUl hidden={true}>
		<div class="flex justify-around">
			<NavLi on:click={addBarPlot} class="flex flex-col items-center py-2  mx-4">
				<svelte:fragment>
					Bar Plot
					<svg
			...
			<NavLi on:click={addAreaPlot} class="flex flex-col items-center py-2 mx-4">
				<svelte:fragment>
					Area Plot
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<NavLi on:click={addScatterPlot} class="flex flex-col items-center py-2  mx-4">
				<svelte:fragment>
					Scatter Plot
					<svg
						class="h-8 w-8"
			...
			<NavLi on:click={addLinePlot} class="flex flex-col items-center py-2  mx-4">
				<svelte:fragment>
					Line Plot
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<NavLi on:click={addPiePlot} class="flex flex-col items-center py-2  mx-4">
				<svelte:fragment>
					Pie Plot
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<NavLi class="flex flex-col items-center py-2  mx-4">
